    ...
    template: `
        <kendo-dialog title="{{ptitulo}}" 
          ...
          <div class="alert alert-danger" *ngIf="enlistaerror">
            ...
            <rutas-addcliepoten *ngIf="cargoConfig && ptipomant=='A'" 
            vparcaptura="{{pvaparam}}"></rutas-addcliepoten>
            <rutas-editcliepoten *ngIf="cargoConfig && ptipomant=='E'" 
                vparcaptura="{{pvaparam}}" 
                vid="{{pid}}" >
             </rutas-editcliepoten>
             <rutas-vertcliepoten *ngIf="cargoConfig && ptipomant=='C'"  
                 vparcaptura="{{pvaparam}}" 
                 vid="{{pid}}" >
            </rutas-vertcliepoten>
            </kendo-dialog>
